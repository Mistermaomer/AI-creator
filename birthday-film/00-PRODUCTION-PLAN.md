...
**פיזיות המבוגר (תיקון מחייב):** יקיר הוא **170 ס"מ**, מבנה אתלטי-קומפקטי. כל פרומפט שמתאר אותו חייב לכלול: `compact 170 cm (5'7") medium athletic build — average height, no fashion-model elongation`. המודלים נוטים למתוח דמויות לפרופורציות דוגמן — זה פסל את גרסה 1 של ה-Sheet שלו.
